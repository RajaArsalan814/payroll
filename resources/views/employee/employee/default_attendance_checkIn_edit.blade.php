        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" required name="check_in" class="form-control" value="{{$attendance->check_in}}" >
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="time" required name="check_out" disabled="true" class="form-control" value="{{$attendance->check_out}}" >
